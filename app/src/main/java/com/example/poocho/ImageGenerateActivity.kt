...
import com.example.poocho.adapter.MessageAdapter
import com.example.poocho.api.ApiUtilities
import com.example.poocho.databinding.ActivityImageGenerateBinding
import com.example.poocho.models.MessageModel
import com.example.poocho.models.request.ChatRequest
import com.example.poocho.models.request.ImageGenerateRequest
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.sendbtn.setOnClickListener{
            if(binding.userMsg.text!!.isEmpty()){
                Toast.makeText(this, "Please ask you question?", Toast.LENGTH_SHORT).show()
            }else{
                callApi()
            }
        }
